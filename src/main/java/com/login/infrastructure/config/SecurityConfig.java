...
import com.login.infrastructure.adapter.input.rest.JwtAuthFilter;
 ...
 *                 Spring la procesa en tiempo de arranque y registra los @Bean
 *                 que
 *                 define: SecurityFilterChain y PasswordEncoder.
 *
 * @EnableWebSecurity: activa la integración de Spring Security con
 *                     Spring MVC. Sin esta anotación, los filtros de seguridad
 *                     no se
 *                     registran en el servlet container y el sistema queda
 *                     desprotegido.
 *                     En Spring Boot 3.x esta anotación también deshabilita la
 *                     configuración de seguridad automática de Spring Boot para
 *                     que
 *                     esta configuración personalizada tome el control
 *                     completo.
 *
 * @RequiredArgsConstructor: inyecta JwtAuthFilter por constructor.
 *                           JwtAuthFilter es @Component, Spring lo detecta y lo
 *                           inyecta aquí.
 *                           SecurityConfig necesita JwtAuthFilter para
